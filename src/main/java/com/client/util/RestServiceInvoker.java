...
public class RestServiceInvoker {
	...
	public RestServiceInvoker() {
		...
		multiValueparameters = new LinkedMultiValueMap<>();
	}

	public <R> R invoke(Class<R> outputClassType) throws Exception {
		this.validate();
		return restTemplate.exchange(URLDecoder
					.decode(builder.buildAndExpand(pathParams)
							.toString(), ENCODING_UTF_8),method, entity, outputClassType)
							.getBody();
	}

	public String invokeAndGetResponseAsJsonString() throws Exception {
		return invoke(String.class);
	}

	public RestServiceInvoker path(String url) {
		this.path = url;
		builder = UriComponentsBuilder.fromHttpUrl(this.path);
		return this;
	}

	public RestServiceInvoker contentType(MediaType contentType) {
		headers.setContentType(contentType);
		return this;
	}

	public RestServiceInvoker acceptType(MediaType acceptType) {
		headers.setAccept(Arrays.asList(acceptType));
		return this;
	}

	public RestServiceInvoker headerParam(String key, Object value) {
	...
	public RestServiceInvoker headerParam(Map<String, String> headerParam) {
	...
	public RestServiceInvoker queryParam(Map<String, String> parameters) {
	...
	public RestServiceInvoker queryParam(String key, Object value) {
		MultiValueMap<String, String> multiValueparameters = new LinkedMultiValueMap<>();
		if (Optional.ofNullable(key).isPresent()) {
	...
	public RestServiceInvoker formParam(Map<String, String> formParams) {
		MultiValueMap<String, String> multiValueparameters = new LinkedMultiValueMap<>();
	...
	public RestServiceInvoker formParam(String key, Object value) {
		multiValueparameters.add(key, value);
		entity = new HttpEntity<>(multiValueparameters, headers);
		return this;
	}

	public RestServiceInvoker pathParam(Map<String, String> pathParam) {
		this.pathParams = pathParam;
		return this;
	}

	public RestServiceInvoker pathParam(String key, String value) {
		if (value != null)
			pathParams.put(key, value);
		return this;
	}

	public RestServiceInvoker body(Object body) {
